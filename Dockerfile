...
COPY --chown=${UID}:${GID} flickr_immich_k8s_sync_operator ./flickr_immich_k8s_sync_operator
...
# ENTRYPOINT ["flickr-immich-k8s-sync-operator"]

ENTRYPOINT ["tini", "--"]
CMD ["flickr-immich-k8s-sync-operator"]
